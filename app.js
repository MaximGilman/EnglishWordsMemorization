...
var CURRENT_TASK_FILE_NAME = getParameterByName('task') || "demo";
...
function nextTask() {
    if (nextTasks.length == 0 && errorTasks.length != 0) {
        ...
        $("#question").text("All words done").append('<h1 style="margin-left: auto; margin-right: auto;"><a href="">Repeat!</a></h1>');
        return;
    }
